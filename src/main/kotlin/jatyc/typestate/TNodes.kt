...
class TArrayTypeNode(pos: Position, val ref: TRefNode) : TRefNode(pos) {
...
class TMethodNode(pos: Position, val returnType: TRefNode, val name: String, val args: List<TRefNode>, /*TIdNode | TStateNode | TDecisionStateNode*/val destination: TNode) : TNode(pos) {
