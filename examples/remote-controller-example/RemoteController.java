...
class RemoteController {
  public static void useMultipleRobot(@Requires("NON_EMPTY") Queue queue) {
  ...
  public static void upcastFails() {
    ...
    r1.unplugArm();
    Queue queue = poweredRobotQueue(4);
    queue.enqueue(r1); //upcast fails
  ...
  private static @Ensures("NON_EMPTY") Queue poweredRobotQueue(int n_robot) {
